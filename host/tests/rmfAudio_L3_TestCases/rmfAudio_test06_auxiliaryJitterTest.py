...
class rmfAudio_test06_auxiliaryJitterTest(rmfAudioHelperClass):
    """
    ...
    def __init__(self, log:logModule=None):
        ...
        Args:
            None
        """
        self.testName  = "test06_auxiliaryJitterTest"
        super().__init__(self.testName, '6', log)
    ...
    def testFunction(self):
        ...
        if aux_support is True:
            ...
            self.log.stepResult(result, 'Auxiliary support in configuration file is False. Auxiliary jitter test test not run')
...
if __name__ == '__main__':
    ...
    test = rmfAudio_test06_auxiliaryJitterTest(summaryLog)
    test.run(False)
