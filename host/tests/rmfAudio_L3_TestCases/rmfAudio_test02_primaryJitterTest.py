...
class rmfAudio_test02_primaryJitterTest(utHelperClass):
    """
    Test class to open capture Primary Audio Data and check if there is jitter detected.

    This class uses the `rmfAudioClass` to run primary data capture,
    downloading necessary test assets, setting up RMF Audio Capture
    and performing verification of audio capture rate.
    """

    # Class variables
    testName  = "test02_primaryJitterTest"
    ...
    def testFunction(self):
        ...
        - Tracks bytes received for Audio data on primary interface.
        ...
        self.log.stepStart('Primary jitter test')
