...
|2|`L1` Tests |`L1` Test Case File for this module |[test_l1_rmfAudioCapture.c](https://github.com/rdkcentral/rdk-halif-test-rmf_audio_capture/blob/main/src/test_l1_rmfAudioCapture.c "test_l1_rmfAudioCapture.c")|
...
- When running the binary, remember to include a profile file as an argument for designated test cases. The following example illustrates this: `./hal_test -p rmfAudioCaptureExtendedEnumsNotSupported.yml`
- Profiles file available in [profile yaml file](./profile/rmfAudioCaptureExtendedEnumsNotSupported.yml)
