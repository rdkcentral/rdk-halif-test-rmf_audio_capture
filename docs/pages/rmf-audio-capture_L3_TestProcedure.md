...
Example Rack configuration File: [example_rack_config.yml](https://github.com/rdkcentral/rdk-halif-test-rmf_audio_capture/blob/main/host/tests/configs/example_rack_config.yml)
...
Example Device configuration File: [deviceConfig.yml](https://github.com/rdkcentral/rdk-halif-test-rmf_audio_capture/blob/main/host/tests/configs/deviceConfig.yml)
...
Example Test Setup configuration File: [rmfAudio_L3_testSetup.yml](https://github.com/rdkcentral/rdk-halif-test-rmf_audio_capture/blob/main/host/tests/rmfAudio_L3_TestCases/rmfAudio_L3_testSetup.yml)
...
Example Test Setup configuration File: [rmfAudio_testConfig.yml](https://github.com/rdkcentral/rdk-halif-test-rmf_audio_capture/blob/main/host/tests/rmfAudioClasses/rmfAudio_testConfig.yml)
